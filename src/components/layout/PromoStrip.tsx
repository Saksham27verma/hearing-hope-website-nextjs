...
export function PromoStrip() {
  return (
    <section
      ...
      aria-label="Rechargeable hearing aids"
    >
      <div className="relative mx-auto max-w-7xl px-4 lg:px-6">
        <div className="relative rounded-[1.75rem] bg-linear-to-r from-[#07111F] via-[#122033] to-brand-orange shadow-[0_24px_60px_-28px_rgba(255,101,3,0.45)]">
          ...
          <div className="relative flex min-h-[8.5rem] items-center gap-6 px-5 py-7 pr-36 sm:min-h-[10rem] sm:px-8 sm:pr-64 lg:pr-80">
            <div className="max-w-xl">
              ...
              <p className="mt-2 text-lg font-bold tracking-tight text-white sm:text-2xl">
                All-day rechargeable hearing aids — at honest listed prices
              </p>
              <p className="mt-1 hidden text-sm text-slate-300 sm:block">
                Premium RIC and BTE models from Signia, Phonak, Widex and Oticon. Try them, then pay
                at the fitting.
              </p>
              <Link
                href="/products"
          ...
          <Image
            ...
            alt="Rechargeable hearing aids in a charging case"
            width={720}
            height={900}
